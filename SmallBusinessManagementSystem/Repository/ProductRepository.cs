...
namespace SmallBusinessManagementSystem.Repository
{
    public class ProductRepository
    {
        ...
        {
            string connectionString = @"Server=DESKTOP-TPUFUO1\SQLEXPRESS01;DataBase=Project1DB;Integrated Security=True";
        ...
        public bool IsExists(ProductModel productModel)
        {
            ...
            {
                //connection
                string conn = @"Server=DESKTOP-TPUFUO1\SQLEXPRESS01;DataBase=Project1DB;Integrated Security=True";
